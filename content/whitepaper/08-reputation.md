...
*(Founder-configurable requirements, such as a founder limiting their own raise to backers above some reputation threshold, are a possible future option. They are not implemented today: at present no raise gates participation on reputation.)*
