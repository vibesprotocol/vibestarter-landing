...
/** Farcaster mark — path verbatim from .claude/assets/farcaster.svg (viewBox 0 0 24 24). */
...
const ROWS: readonly SignalRow[] = [
  ...
  },
  {
    ...
    label: "Farcaster",
    value: "@loom · 4.1k",
    note: "real social graph, not followers bought",
  },
  {
    k: "history",
    mark: <HexMark />,
        ...
        <div className="mt-14 flex flex-col items-center gap-12 lg:flex-row lg:items-center lg:gap-16">
          ...
          <div data-rep-in className="shrink-0">
            <FounderAscii
              resolution={0.2}
              sway={0.22}
              className="block h-[520px] w-[440px] max-w-full overflow-hidden"
            />
          </div>
